...
public class LevelUserSpinnerAdapter extends ArrayAdapter<String> {

    private List<String> data;
    private Context context;
    private int resource;

    public LevelUserSpinnerAdapter(@NonNull Context context, int resource, List<String> stringData) {
